...
- [Introduction to the course (prof. Corno, Web Applications I)](./slide/00-intro-2026-WA1.pdf)
- [Introduction to the course (prof. De Russis, Applicazioni Web I)](./slide/00-intro-2026-AW1.pdf)
...
## Laboratories
The texts of each laboratory are available in the [`lab-2026` repository](https://github.com/polito-webapp1/lab-2026).
